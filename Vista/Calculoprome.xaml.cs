...
public partial class Calculoprome : ContentPage
{
    public Calculoprome(string Login)
    {
   
		InitializeComponent();
       DisplayAlert("Bienvenido", "" + Login, "Continuar");
        LblUsuario.Text = "Usuario Conectado: " + Login;
